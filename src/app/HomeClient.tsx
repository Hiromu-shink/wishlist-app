...
export function HomeClient() {
  ...
  return (
    <div className="mx-auto max-w-6xl p-6 space-y-6">
      ...
      <section className="grid grid-cols-1 gap-4 [@media(min-width:430px)]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {isLoading || pending ? (
      ...
      {somedayItems.length > 0 && (
        <section className="mt-8 pt-6 border-t">
          ...
          <div className="grid grid-cols-1 gap-4 [@media(min-width:430px)]:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
